...
function insert_bill_detail($id_product, $id_bill, $id_bill_status, $quantity, $payment, $note) {
    $sql = "INSERT INTO `bill_detail` (`id_product`, `id_bill`, `id_voucher`, `id_bill_status`, `quantity`, `payment`, `note`)
            VALUES ('$id_product', '$id_bill', NULL, '$id_bill_status', '$quantity', '$payment', '$note')";
    return pdo_execute($sql);
}
